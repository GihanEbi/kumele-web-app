  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="bg-app-background-tertiary rounded-2xl w-full max-w-sm max-h-[95vh] shadow-lg flex flex-col overflow-y-auto no-scrollbar p-4 sm:p-5"
      >
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar p-4 sm:p-5">
          ...
          <div className="flex justify-between items-start mb-4 mt-3">
            ...
            >
              <ShareIcon  className={`${isDark ? "text-black" : "text-white"} `} />
            </button>
          </div>
