...
const InviteModal: React.FC<InviteModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-white dark:bg-black rounded-t-2xl shadow-2xl max-w-md mx-auto">
        <div className="p-4 max-h-[85vh] overflow-y-auto">
          ...
          {/* Event Details Box */}
          <div className="text-left p-4 bg-zinc-100 dark:bg-app-blog-selected-tabs-text rounded-xs mb-2 space-y-2">
