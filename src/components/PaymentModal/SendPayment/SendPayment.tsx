    ...
    <div className="fixed inset-0 z-[2000] flex flex-col font-sans bg-app-background-primary">
      ...
      <div className="flex-grow w-full max-w-sm mx-auto p-6 flex flex-col">
        ...
        <div className="w-full">
          <h2 className="text-app-blog-card-heading font-plusJakartaSans font-semibold text-[22px]">Send payment</h2>
        ...
        <div className="border border-app-range-slider-track-active  mt-8 w-full">
          ...
          <div className="flex justify-between items-center p-4">
            <span className="text-app-blog-card-author-text font-plusJakartaSans font-normal text-[16px]">Amount</span>
          ...
          {/* Address Row */}
          <div className="flex justify-between items-center p-4">
            <span className="text-app-blog-card-author-text font-plusJakartaSans font-normal text-[16px]">BTC Address</span>
            <div className="flex items-center gap-3">
              <span className="text-app-blog-card-author-text font-plusJakartaSans font-semibold text-[16px]">
                {BTC_ADDRESS}
              </span>
        ...
        <div className="my-6 flex items-center gap-x-4">
          ...
          <span className="text-app-blog-card-author-text font-plusJakartaSans font-normal text-[16px]">Or</span>
          <div className="h-px flex-1 bg-app-range-slider-track-active"></div>
        </div>
        ...
        <div className="w-full space-y-3">
          ...
          <button
            onClick={onClose}
            className="w-full text-app-blog-unselected-tabs-text font-plusJakartaSans font-normal text-[16px] py-4 rounded-lg"
          >
            Cancel
          </button>
        </div>
